"""Example module with NumPy style docstrings.

This module demonstrates documentation as specified by the
`NumPy Python Style Guide`_. Docstrings may extend over multiple lines.
...
Notes
-----
    This is an example of an indented section. It's like any other section, but
    the body is indented to help it stand out from surrounding text.
...
def function_with_pep484_type_annotations(param1: int, param2: str) -> bool:
    ...
    Notes
    -----
    The return type must be duplicated in the docstring to comply with the
...
def module_level_function(param1, param2=None, *args, **kwargs):
    ...
    Function parameters should be documented in the ``Parameters`` section. The
    ...
    The format for a parameter is::
        ...
        name : type
            ...
            indented to match the first line of the description. The ": type"
            is optional.
    ...
    **kwargs
    ...
    ------
    AttributeError
        The ``Raises`` section is a list of all exceptions that are relevant to
        the interface.
    ValueError
...
class ExampleClass(object):
    ...
    ``Args`` section. Alternatively, attributes may be documented inline with
    ...
    def __init__(self, param1, param2, param3):
        ...
        Either form is acceptable, but the two should not be mixed. Choose one
        convention to document the :meth:`__init__` method and be consistent
        with it.
